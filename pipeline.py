...
def auto_rate(prompt: str,
    ...
    rating_prompt = (
        ...
        "is culturally appropriate and high quality (according to your personal preferences)? Be critical. Give an explanation for "
...
def main():
    ...
    num_agents = 5
    agents = create_and_save_agents(num_agents=num_agents, save_path=agents_path)

    num_users = 5
    auto_rating_funcs = [
        partial(auto_rate, model="gpt-4o-mini", system_prompt=generate_system_prompt())
        for agent in agents
    ]
